...
const CreatePost = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const res = await axios.post(
        'https://us-east-1.aws.data.mongodb-api.com/app/shesaidit-abcvc/endpoint/createPost',
        {
          body: content,
          title: title,
          category: topic,
  ...
  return (
    <div onClick={handleCloseSearch} className='flex h-screen bg-[#fb6f92]   '>
      <SideBar />
      <div className='flex flex-col flex-grow  mt-16  '>
        <div className='min-w-[300px] md:w-[500px] mt-5 md:mx-auto mx-2 '>
          ...
          <form
            ...
            className='flex flex-col  rounded-md bg-[#ffe5ec] mt-2 p-4 gap-3'
          >
            <input
              className='h-11  bg-[#ffffff] rounded-md text-[#fb6f92] p-2'
              type='text'
              placeholder='Title'
            ...
            />
            <textarea
              className='h-44  bg-[#ffffff] rounded-md text-[#fb6f92] p-2 '
              type='text'
              placeholder='Text'
            ...
            <button
             ...
             h-10 ${
               !disabled
                 ? ' bg-[#fb6f92] h-14 text-[#f6f7f9] hover:opacity-90'
