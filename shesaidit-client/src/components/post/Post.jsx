...
export const Post = ({ post, isLoggedIn, setModal, fetchData, isSubmit }) => {
  ...
  const isSaved = async () => {
    if (token) {
      await fetch('https://us-east-1.aws.data.mongodb-api.com/app/shesaidit-abcvc/endpoint/user', {
        method: 'GET',
        headers: {
  ...
  const voteHandler = async (post, voteType) => {
    ...
    await fetch('https://us-east-1.aws.data.mongodb-api.com/app/shesaidit-abcvc/endpoint/vote', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token,
  ...
  const saveHandler = async (post) => {
    ...
    await fetch('https://us-east-1.aws.data.mongodb-api.com/app/shesaidit-abcvc/endpoint/savePost', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token,
